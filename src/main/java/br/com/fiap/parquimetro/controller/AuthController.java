...
import br.com.fiap.parquimetro.records.auth.AccountCredentialsRecord;
import br.com.fiap.parquimetro.records.auth.CreateCredentialsRecord;
import br.com.fiap.parquimetro.records.auth.TokenRecord;
import br.com.fiap.parquimetro.service.AuthService;
...
public class AuthController {
    ...
    private final br.com.fiap.parquimetro.service.AuthService authService;
    ...
    public ResponseEntity<ResponseBase<Void>> create(
        ...
        if (data == null|| data.password() == null || data.password().isBlank()) {
